...
# On Apple, QHostInfo uses CFNetwork rather than libresolv. Qt 6.10.2 only links
# WrapResolv when both dnslookup and libresolv are on, but qhostinfo_unix.cpp
# still calls res_ninit/res_nclose when libresolv auto-detects ON. Disable the
# libresolv feature on Apple to avoid an undefined-symbol link error.
if(VCPKG_TARGET_IS_OSX OR VCPKG_TARGET_IS_IOS)
    list(APPEND FEATURE_OPTIONS -DFEATURE_libresolv:BOOL=OFF)
endif()
