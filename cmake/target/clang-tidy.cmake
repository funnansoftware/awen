...
if(CLANG_TIDY)
    ...
    set(CLANG_TIDY_SOURCE_FILTER "^${CMAKE_SOURCE_DIR}/(app|src)/.*\\.(cpp|ixx)$")
    ...
    if(CLANG_TIDY_DIFF)
        ...
        message(STATUS "clang-tidy-diff not found - clang-tidy-diff target will be skipped.")
    endif()
else()
    message(STATUS "clang-tidy executable not found - clang-tidy target will be skipped.")
endif()
